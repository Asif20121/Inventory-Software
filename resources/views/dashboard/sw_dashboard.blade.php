                        ...
                        <div class="row smbox shadow-sm" style="width: inherit;">
                            ...
                            <div class="col-md-12">
                                <div class="row d-flex justify-content-between">
                                    <div class="col-md-6   d-block d-flex">
                                        <div class="info-lg p-2">
                                            <i class="fas fa-user-check text-success fa-2x pt-2"></i>
                                            <p class="m-0">Active</p>
                                    ...
                                    <div class="col-md-6   d-block d-flex">
                                        <div class="info-lg p-2">
                                            <i class="fas fa-user-times text-primary fa-2x pt-2"></i>
                                            <p class="m-0">Inactive</p>
    ...
    <script>
        ...
        const purchaseExpense=(total_purchase_amount,pending_purchase_amount,approve_purchase_amount,expense)=>{
            ...
            var donutData2 = {
                ...
                datasets: [{
                    data: [ total_purchase_amount, pending_purchase_amount, approve_purchase_amount, expense],
    ...
    <script>
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.sw_dashboard_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        $(document).on('change', '#store,#from_date,#date_to', function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.sw_dashboard_search') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
