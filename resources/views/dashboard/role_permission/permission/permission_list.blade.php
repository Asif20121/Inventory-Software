                        ...
                        <div class="card">
                            ...
                            @endif
                                ...
                                <div class="card-tools">
                                            {{-- <a class="btn btn-primary" href="{{ route('rpm.permission.create') }}">Add New Permission</a> --}}
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($permission as $key=>$data)
                                            <tr>
                                                ...
                                                <td scope="col" class="text-left">{{ $data->group_name }}</td>
                                                {{-- <td scope="col" class="text-center" class="text-center">
                                                    <a href="{{ route('rpm.permission.edit', $data->id) }}" class="h5"><i
                                                        class="fas fa-edit text-info"></i> </a>

                                                        <a href="{{ route('rpm.permission.delete', $data->id) }}" class="delete_data h5 text-danger"><i class="fas fa-trash-alt"></i></a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
