    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Daily Cancel Invoice</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <section class="col-lg-12 connectedSortable">
                        <div class="card">
                            <div class="card-header">
                                <div class="">
                                    <form action="{{ route('admin.daily_cancel_inv_list_print') }}" target="_blank"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.daily_cancel_inv_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        let showData = async (res) => {
            ...
            if (res.length != 0) {
                await $.each(res, function(key, value) {
                    ...
                    let daily_sales_details = "{{ route('admin.daily_cancel_inv_details', ':id') }}";
        ...
        $(".search_btn").click(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.daily_cancel_inv_search') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
