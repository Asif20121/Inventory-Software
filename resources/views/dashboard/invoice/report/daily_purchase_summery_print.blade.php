...
<body>
    <header class="clearfix">
        ...
        @endif
        <div class="info">
            <h2><span>Purchase Summery Report</span></h2>
            <h5>
    ...
    <main>
        <p style="page-break-after: never;">
            @if (isset($employee) || isset($supplier) || $status !='')
                <div style="background-color: #faf8f8;padding:1%; width: 96%; margin-left: 1%;">
                    <div style="margin-left: 1%;  font-size: 14px; font-family: sans-serif; color: #5b5b5b;">
                        ...
                        @endif
                        @if ($status=='approve') <h4 class="title"> &nbsp; <b>Status:</b>&nbsp; <span style="background: rgb(47, 255, 57);padding:2px 2px;border-radius: 5%"> Approve</span> </h4>@endif
                        @if ($status=='pending') <h4 class="title"> &nbsp; <b>Status:</b>&nbsp; <span style="background: rgb(241, 255, 47);padding:2px 2px;border-radius: 5%"> Pending</span> </h4>@endif
                        @if ($status=='cancel') <h4 class="title"> &nbsp; <b>Status:</b>&nbsp; <span style="background: rgb(255, 47, 47);padding:2px 2px;border-radius: 5%"> Cancel</span> </h4>@endif
                    </div>
                </div>
            @endif
        ...
        <table  style="width: 80%; margin: 0 auto; border: 0px;" >
            <tbody>
                <tr>
                    ...
                    <td style="border: 0px;">:&nbsp; {{ $purchase[0]->total_tax !=null ? $purchase[0]->total_tax :0 }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="border: 0px;" colspan="2"><hr ></td>
                </tr>
                <tr>
