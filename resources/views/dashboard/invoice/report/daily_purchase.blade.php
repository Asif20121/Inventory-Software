    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Daily Purchase</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="">
                                    <form action="{{ route('admin.daily_purchase_search_print') }}" method="post" autocomplete="off" target="_blank">
                                        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.daily_purchase_data') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        async function pending_showData(res) {
            ...
            if (res.length != 0) {
                await $.each(res, function(key, value) {
                    ...
                    let purchase_manage_view = "{{ route('admin.daily_purchase_view', ':id') }}";
...
// Search Data
        $(".search_btn").click(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.daily_purchase_search') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
