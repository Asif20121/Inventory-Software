...
<body>
    ...
    <main>
        <p style="page-break-after: never;">
            @if (isset($employee) || isset($customer))
            ...
            <div class="all">
                <div class="total_one">
                    <div style="width: 45%; float: left;">Total Payable Amount</div>
                    <div style="width: 45%; float: right;">: &nbsp;{{ $invoice_details_arr[0]->total_payable_amount != '' ? $invoice_details_arr[0]->total_payable_amount : '0' }}</div>
                </div> <br> <br>

                <div class="total_two">
                    <div style="width: 45%; float: left;">Total Paid Amount</div>
                    <div style="width: 45%; float: right;">: &nbsp;{{ $invoice_details_arr[0]->total_paid != '' ? $invoice_details_arr[0]->total_paid : '0' }}</div>
                </div> <br>
                <div style="width: 60%;">
                    <hr style="height:0.5px;border:none;color:#333;background-color:#474646;">
                </div>
                <div class="total_three">
                    <div style="width: 45%; float: left;">Total Due Amount</div>
                    <div style="width: 45%; float: right;">: &nbsp;{{ $invoice_details_arr[0]->total_due != '' ? $invoice_details_arr[0]->total_due : '0' }}</div>
                </div>
            </div>
        </p>
