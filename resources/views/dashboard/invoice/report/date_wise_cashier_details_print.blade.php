    ...
    <main>
        ...
        <div style="background-color: #faf8f8;padding:2%;">
            <div
                ...
                <p>
                    {{ isset($invoice['customer_name']) ? $invoice['customer_name'] : 'Empty' }}<br>
                    {{ isset($invoice['customer_email']) ? $invoice['customer_email'] : 'Empty' }}<br>
                    {{ isset($invoice['customer_phone']) ? $invoice['customer_phone'] : 'Empty' }}<br>
