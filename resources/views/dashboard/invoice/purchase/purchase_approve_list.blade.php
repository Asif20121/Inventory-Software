    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Purchase Approve List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="">Purchase Approve</a></li>
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="">
                                    <form action="{{ route('admin.purchase_approve_list_print') }}" method="post" autocomplete="off" target="_blank">
                                        @csrf
                            ...
                            <div class="card-header">
                                <h3 class="card-title">
                                    <b>Total</b> : &nbsp;<span id="total_item"
                                        class="bg-success rounded px-1 text-left">0</span>
                                </h3>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.purchase_approve_list_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
...
// Search Data
        $(".search_btn").click(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.purchase_approve_list_search') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
