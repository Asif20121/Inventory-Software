        ...
        <table class="order-details">
            <thead>
                <tr class="bg-blue">
                    ...
                    <th width="15%" class="text-center">E.Date</th>
                    <th width="15%" class="text-center">S.Name</th>
                    <th width="15%" class="text-center">EType</th>
                    <th width="10%" class="text-center">Cost</th>
                    <th width="10%" class="text-center">Description</th>
                    <th width="25%" class="text-center">Added By</th>
                </tr>
            </thead>
            <tbody>
            ...
            <tbody>
                <tr class="bg-light">
                    <td colspan="5" class="text-center"><strong>Total Cost</strong></td>
