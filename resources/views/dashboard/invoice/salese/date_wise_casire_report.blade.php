                    ...
                    <section class="col-lg-12 connectedSortable">
                        <div class="card">
                            <div class="card-header">
                                <div class="">
                                    <form action="{{ route('admin.print_date_wise_cashier_report') }}" target="_blank" method="post"
                                        autocomplete="off">
                                        @csrf
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered search_datatable">
                                        ...
                                        <tbody>
                                            <tr class="bg-light">
                                                <td colspan="4" class="text-right"><strong>Total Receive Amount</strong></td>
                                                <td colspan="2" class="text-center"><strong id="total_receive_amount" >0</strong></td>
                                            </tr>
                                        </tbody>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.date_wise_cashier_report_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        let showData = async (res) => {
            ...
            if (res.length != 0) {
                await $.each(res, function(key, value) {
                    i++;
                    let invoice_details = "{{ route('admin.date_wise_cashier_report_details', ':id') }}";
        ...
        $(".search_btn").click(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.search_date_wise_cashier_report') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
