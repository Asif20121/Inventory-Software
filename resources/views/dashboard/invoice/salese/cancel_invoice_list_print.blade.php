...
<body>
    <header class="clearfix">
        ...
        @else
            <div id="company">
                ...
                <div> Phone:&nbsp;{{ isset($admin_logos->contact_number) ? $admin_logos->contact_number : '' }}</div>
                <div>E-mail:&nbsp;<a href="#">{{ isset($admin_logos->email) ? $admin_logos->email : '' }}</a></div>
            </div>
        @endif
        <div class="info">
            <h2><span>Cancel Invoice List</span></h2>
            <h5>
    ...
    <main>
        <p style="page-break-after: never;">
            ...
            @if (isset($employee) || isset($customer) || isset($invoice))
                <div style="background-color: #faf8f8;padding:1%; width: 96%; margin-left: 1%;">
                    <div style="margin-left: 1%;  font-size: 14px; font-family: sans-serif; color: #5b5b5b;">
                        ...
                        @if (isset($invoice))
                            <h4 class="title">
                                &nbsp; <b>Invoice no :</b>&nbsp;{{ $invoice->invoice_no != '' ? $invoice->invoice_no : '' }}
                            </h4>
                        @endif
                    </div>
                </div>
        ...
        <table class="order-details">
            <thead>
                <tr class="bg-blue">
                    ...
                    <th width="30%" class="text-center">Invoice Info</th>
                    <th width="25%" class="text-center">Customer Info</th>
                    <th width="25%" class="text-center">Payment Info</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                @elseif($data->paid_status == 2)
                                    <span class="white_color p-1 bg-rounded"
                                        style="background-color:#ff3300;">Canceled</span>
                                @endif
                            </td>
                        </tr>
                        @php
