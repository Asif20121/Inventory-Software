                    ...
                    <section class="col-lg-12 connectedSortable">
                        <div class="card">
                            <div class="card-header">
                                <div class="">
                                    <form action="{{ route('admin.cancel_print_invoice_list') }}" target="_blank"
                                        ...
                                        <div class="row d-flex justify-content-between">
                                            ...
                                            <div class="col-lg-2 col-md-3">
                                                ...
                                                <div class="input-container">
                                                    <input name="to_date" type="text" id="to_date" value="{{ date('d-m-Y') }}" placeholder="dd-mm-yy"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.cancel_invoice_list_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        let showData = async (res) => {
            ...
            if (res.length != 0) {
                ...
                $.each(res, function(key, value) {
                    ...
                    let cancel_invoice_details = "{{ route('admin.cancel_invoice_details', ':id') }}";
                    cancel_invoice_details = cancel_invoice_details.replace(':id', value.invoice_id);
                            ...
                            <tr>
                                ...
                                <td scope="col" class="text-left">
                                 ...
                                 <td scope="col" class="text-center">
                                    <a type='button' data-action="${cancel_invoice_details}" class="btn-sm btn-secondary mb-2 text-white open_modal" data-title="Invoice Details  (Invoice no. : ${value.invoice_no}) (Date : ${d.getDate()+' '+(d.toLocaleString('default', { month: 'long' }))+' '+d.getFullYear()})" data-modal="common_modal_xl" title="Invoice Details"> View</a> <br>
                                </td>
                            </tr>
                            `;
                })
        ...
        $(".search_btn").click(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.cancel_search_invoice_list') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
