                    ...
                    <section class="col-lg-12 connectedSortable">
                        <div class="card">
                            <div class="card-header">
                                <div class="">
                                    <form action="{{ route('admin.print_invoice_list') }}" target="_blank" method="post"
                                        autocomplete="off">
                                        @csrf
                                        <div class="row d-flex justify-content-between">
                                            ...
                                            <div class="col-lg-2 col-md-3">
                                                ...
                                                <div class="input-container">
                                                    <input name="to_date" type="text" id="to_date" value="{{ date('d-m-Y') }}" placeholder="dd-mm-yy" class="form-control datepicker">
                                                    <i class="far fa-calendar-alt custom_icon"></i>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <span id="due_list" class="bg-warning rounded px-1 text-left">0</span>&nbsp;
                                <span id="paid_list" class="bg-success rounded px-1 text-left">0</span>&nbsp;
                                <b>Total</b>: <span id="total_list" class="bg-primary rounded px-1 text-left">0 </span>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.invoice_list_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        let showData = async (res) => {
            ...
            if (res.length != 0) {
                            ...
                            <tr>
                                ...
                                <td scope="col" class="text-left">
                                 ...
                                 <td scope="col" class="text-center">
                                     <a type='button' target="_blank" class="btn-sm btn-dark" href="${edit_invoice}"  title="Edit Invoice">Edit</a> &nbsp;
                                     <a type='button' data-action="${invoice_details}" class="btn-sm btn-secondary mb-2 text-white open_modal" data-title="Invoice Details  (Invoice no. : ${value.invoice_no}) (Date : ${d.getDate()+' '+(d.toLocaleString('default', { month: 'long' }))+' '+d.getFullYear()})" data-modal="common_modal_xl" title="Invoice Details"> View</a> <br>
                ...
                $("#due_list").text(due_count)
                $("#paid_list").text(paid_count)
                $("#total_list").text(due_count+paid_count)
        ...
        $(".search_btn").click(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.search_invoice_list') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
