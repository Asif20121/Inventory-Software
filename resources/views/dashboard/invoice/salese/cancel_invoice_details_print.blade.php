...
<body>
    <header class="clearfix">
        ...
        <div class="info">
            <h2>
                <span>CANCEL INVOICE DETAILS</span>
            </h2>
        </div>
    </header>
    <footer>
    ...
    <main>
        ...
        <div style="background-color: #faf8f8;padding:2%;">
            <div
                ...
                <p>
                    ...
                    {{ isset($invoice['customer_address']) ? $invoice['customer_address'] : '' }}
                </p>
            </div>
            <div
        ...
        <table>
            <thead>
                <tr class="bg-blue">
                    <th width="05%" class="text-center">Sl.No.</th>
                    ...
                    <th width="10%" class="text-center">UPWD</th>
                    <th width="20%" class="text-center">Total UPWOD</th>
                    <th width="25%" class="text-center">Total Price</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tbody>
                    @if (count($invoice['cancel_invoice_list']) > 0)
                        @foreach ($invoice['cancel_invoice_list'] as $key => $item)
                            <tr style="background-color: #f1a6a6f0 !important">
                                <td class="text-center">{{ $key + 1 }}</td>
                                <td class="text-center">{{ $item->product_name ? $item->product_name : '' }}</td>
        ...
        <table>
            <thead>
                <tr class="bg-blue">
                    ...
                    <th width="20%" class="text-center">Return Amount</th>
                    <th width="20%" class="text-center">Payment Method</th>
                    <th width="20%" class="text-center">Received By</th>
                    <th class="text-center">Cancel By</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border: 0px;">:&nbsp;
                            @if ($invoice['paid_status'] == 0)
                                ...
                                <span class="white_color p-1 bg-rounded" style="background-color:#b8173a;">Cancel</span>
                            @endif
                        </td>
                    </tr>
                </tbody>
