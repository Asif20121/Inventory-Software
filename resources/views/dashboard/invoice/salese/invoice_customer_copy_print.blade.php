        ...
        <div id="company">
            ...
            <div>
                @if (isset($invoice['store_email']))
                    Email : &nbsp;<a href="#">{{ isset($invoice['store_email']) ? $invoice['store_email'] : '' }}</a>
                @else
                @endif
            </div>
            <div>
                @if (isset($invoice['store_web_url']))
                    Web: &nbsp;<a href="#">{{ isset($invoice['store_web_url']) ? $invoice['store_web_url'] : '' }}</a>
                @else
                @endif
            </div>
        </div>
    ...
    <main>
        <div style="background-color: #faf8f8;padding:2%;">
            ...
            <div
                ...
                <p>
                    Invoice Date: {{ date('d F Y', strtotime($invoice['date'])) }}<br> <br> <br>
                </p>
            </div>
        </div>
