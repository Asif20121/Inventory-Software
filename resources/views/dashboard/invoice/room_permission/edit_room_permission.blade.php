...
if ($emp_id !='' || $emp_id != null) {
    $emp_name=DB::table('admins')->where('id',$emp_id)->first()->name;
}
                        ...
                        <div class="card">
                            ...
                            @endif
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('admin.room_permission_list') }}">Store Privilege
                                        List</a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <form
                                    action="{{ route('admin.room_permission_update', $id) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-11 col-sm-12 mt-2 text-left">
                                            <input type="text" class="form-control" value="{{$emp_name}}" disabled placeholder="Search Employee" id="search_employee">
                                        </div>
                                    </div>
                                    <hr style="width: 100%">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12 text-left">
                                            <div class="row mt-5 ">
                                                <div class="col-md-6"> <label for="">
                                                    <strong>{{$key+1}}. {{$st->store_name}}</strong></label>
                                                </div>
                                                <div class="col-md-6">
                                                    <input name="store[]" class="form-control store_check"  {{$st->store_table_id == $st->spd_store_id ? 'checked' : ''}} type="checkbox" value="{{$st->store_table_id}}">
                                                </div>
                                            </div>
