        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row ">
                    ...
                    {{-- Sales overview --}}
                    <div class="col-md-12 col-sm-12 px-3 mb-3 d-block d-flex ">
                        <div class="row smbox shadow-sm  w-100">
                            <div class="col-10">
                    ...
                    {{-- Circuler Graph-1 --}}
                    <div class="col-md-12 col-12 px-3 mb-3 d-block d-flex">
    ...
    <script>
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                type: "get",
                dataType: "json",
                url: "{{ route('admin.sales_dashboard_show') }}",
                beforeSend: function() {
                    uiBlock()
                },
        ...
        $(document).on('change', '#store,#from_date,#date_to', function() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.sales_dashboard_search') }}",
                beforeSend: function() {
                    uiBlock()
                },
                success: function(res) {
