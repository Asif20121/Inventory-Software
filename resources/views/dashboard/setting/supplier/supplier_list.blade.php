                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('invoice_setting.supplier_create') }}">Add New Supplier </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                            ...
                                            @foreach ($supplier as $key => $data)
                                                <tr>
                                                    ...
                                                    <td scope="col" class="text-left">
                                                        <strong> SupplierName</strong>:{{ $data->supplier_name }}<br>
                                                        <strong>Phone </strong>:{{ $data->phone }} <br>
                                                        <strong>Email</strong>:{{$data->email}}<br>
                                                    </td>
                                                    <td scope="col" class="text-left">{{ $data->address }}</td>
                                                    <td scope="col" class="text-left">
                                                        <textarea class="form-control" rows="3" cols="25" disabled>{{ $data->description }}</textarea>
                                                    </td>
                                                    <td class="text-left">
                                                        @if ($data->status == 1)
                                                        <span class="bg-success rounded px-1">Active</span>
                                                    ...
                                                    <td scope="col" class="text-center" class="text-center">
                                                            ...
                                                            <a href="{{ route('invoice_setting.supplier_edit', $data->id) }}"
                                                                class="h5"><i class="fas fa-edit text-info"></i> </a>

                                                            <a href="{{ route('invoice_setting.supplier_delete', $data->id) }}"
