                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('setting.company_create') }}">Add New Company </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        @if (isset($company))
                                            @foreach ($company as $key => $data)
                                                <tr>
                                                    ...
                                                    <td scope="col" class="text-left">{{ $data->company_name }}</td>
                                                    <td class="text-left">
                                                        @if ($data->status == 1)
                                                        <span class="bg-success rounded px-1">Active</span>
                                                        @else
                                                    ...
                                                    <td scope="col" class="text-center" class="text-center">
                                                            ...
                                                            <a href="{{ route('setting.company_edit', $data->id) }}"
                                                                class="h5"><i class="fas fa-edit text-info"></i> </a>

                                                            <a href="{{ route('setting.company_delete', $data->id) }}"
