    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ $id ? 'Edit Expense Type' : 'Add New Expense Type' }} </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                            <a class="btn btn-primary" href="{{ route('invoice_setting.expense_list') }}">Expense Type
                                                List</a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{ $id ? route('invoice_setting.expense_update', $id) : route('invoice_setting.expense_store') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div  class="col-md-8 col-sm-12 mt- text-left">
                                            ...
                                            <input type="text" name="type_name" class="form-control bg-light"
                                                placeholder="Expense Type" value="{{$type_name}}">
