                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('invoice_setting.unit_create') }}">Add New Unit </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        @if (isset($unit))
                                            @foreach ($unit as $key => $data)
                                                <tr>
                                                    ...
                                                    <td scope="col" class="text-center">{{ $data->unit_name }}</td>
                                                    ...
                                                    <td scope="col" class="text-center">
                                                            <a href="{{ route('invoice_setting.unit_edit', $data->id) }}" class="h5"><i class="fas fa-edit text-info"></i> </a>

                                                            <a href="{{ route('invoice_setting.unit_delete', $data->id) }}" class="delete_data h5 text-danger"><i class="fas fa-trash-alt"></i></a>
