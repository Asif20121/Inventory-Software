                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('setting.designation_create') }}">Add New Designation </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        @if (isset($designation))
                                            @foreach ($designation as $key => $data)
                                                <tr>
                                                    ...
                                                    <td scope="col" class="text-left">{{ $data->designation_name }}</td>
                                                    <td class="text-left">
                                                        @if ($data->status == 1)
                                                        <span class="bg-success rounded px-1">Active</span>
                                                        @else
                                                    ...
                                                    <td scope="col" class="text-center" class="text-center">
                                                            ...
                                                            <a href="{{ route('setting.designation_edit', $data->id) }}"
                                                                class="h5"><i class="fas fa-edit text-info"></i> </a>

                                                            <a href="{{ route('setting.designation_delete', $data->id) }}"
