                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('invoice_setting.payment_create') }}">Add New Payment Type </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                            ...
                                            @foreach ($payment as $key => $data)
                                                <tr>
                                                    ...
                                                    <td scope="col" class="text-center" class="text-center">
                                                            ...
                                                            <a href="{{ route('invoice_setting.payment_edit', $data->id) }}"
                                                                class="h5"><i class="fas fa-edit text-info"></i> </a>

                                                            <a href="{{ route('invoice_setting.payment_delete', $data->id) }}"
