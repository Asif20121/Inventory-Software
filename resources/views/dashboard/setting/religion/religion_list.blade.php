                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('setting.religion_create') }}">Add New Religion </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <table class="table border table-bordered datatable">
                                    <thead class="bg-secondary">
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center">Religion Name</th>
                                        ...
                                        @if (isset($religion))
                                            @foreach ($religion as $key => $data)
                                                <tr>
                                                    ...
                                                    <td scope="col" class="text-left">{{ $data->religion_name }}</td>
                                                    <td class="text-left">
                                                        @if ($data->status == 1)
                                                        <span class="bg-success rounded px-1">Active</span>
                                                        @else
                                                    ...
                                                    <td scope="col" class="text-center" class="text-center">
                                                            ...
                                                            <a href="{{ route('setting.religion_edit', $data->id) }}"
                                                                class="h5"><i class="fas fa-edit text-info"></i> </a>

                                                            <a href="{{ route('setting.religion_delete', $data->id) }}"
