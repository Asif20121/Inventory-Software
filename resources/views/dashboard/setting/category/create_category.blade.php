...
@php
    ...
    $category_name = isset($data->category_name) && $data->category_name != '' ? $data->category_name : '';
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ $id ? 'Edit Category' : 'Add New Category' }} </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                            <a class="btn btn-primary" href="{{ route('invoice_setting.category_list') }}">category
                                                List</a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{ $id ? route('invoice_setting.category_update', $id) : route('invoice_setting.category_store') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div  class="col-md-8 col-sm-12 mt- text-left">
                                            <label for="">Category Name</label> <span class="text-danger">*</span>
                                            <input type="text" name="category_name" class="form-control bg-light"
