                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-primary" href="{{ route('invoice_setting.category_create') }}">Add New Category </a>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        @if (isset($category))
                                            @foreach ($category as $key => $data)
                                                <tr>
                                                    ...
                                                    <td scope="col" class="text-left">{{ $data->category_name }}</td>
                                                    <td class="text-left">
                                                        @if ($data->status == 1)
                                                        <span class="bg-success rounded px-1">Active</span>
                                                        @else
                                                    ...
                                                    <td scope="col" class="text-center" class="text-center">
                                                            ...
                                                            <a href="{{ route('invoice_setting.category_edit', $data->id) }}"
                                                                class="h5"><i class="fas fa-edit text-info"></i> </a>

                                                            <a href="{{ route('invoice_setting.category_delete', $data->id) }}"
